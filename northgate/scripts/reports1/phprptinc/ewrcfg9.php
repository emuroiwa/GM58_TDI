...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "northgate", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", '33mR9xRuPCqAULYu', TRUE); // Random key for encryption
