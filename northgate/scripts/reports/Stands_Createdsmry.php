...
<?php } ?>
	<!-- Bottom slot -->
<a id="cht_Stands_Created_Stands_Created_Bar"></a>
<div class="">
<div id="div_ctl_Stands_Created_Stands_Created_Bar" class="ewChart">
<div id="div_Stands_Created_Stands_Created_Bar" class="ewChartDiv"></div>
<!-- grid component -->
<div id="div_Stands_Created_Stands_Created_Bar_grid" class="ewChartGrid"></div>
</div>
</div>
<?php

// Set up chart object
$Chart = &$Table->Stands_Created_Bar;
...
?>
<?php include_once "Stands_Created_Stands_Created_Barchart.php" ?>
...
<?php } ?>
<?php } ?>
<a id="cht_Stands_Created_Stands_Created_Pie"></a>
<div class="">
<div id="div_ctl_Stands_Created_Stands_Created_Pie" class="ewChart">
<div id="div_Stands_Created_Stands_Created_Pie" class="ewChartDiv"></div>
<!-- grid component -->
<div id="div_Stands_Created_Stands_Created_Pie_grid" class="ewChartGrid"></div>
</div>
</div>
<?php

// Set up chart object
$Chart = &$Table->Stands_Created_Pie;
...
$Chart->ShowTempImage = ($Page->Export == "pdf" || $Page->CustomExport <> "" || $Page->Export == "email" || $Page->Export == "excel" && defined("EWR_USE_PHPEXCEL") || $Page->Export == "word" && defined("EWR_USE_PHPWORD"));
?>
<?php include_once "Stands_Created_Stands_Created_Piechart.php" ?>
<?php if ($Page->Export <> "email" && !$Page->DrillDown) { ?>
<?php if ($Page->Export == "" && !$Page->DrillDown) { ?>
<a href="javascript:void(0);" class="ewTopLink" onclick="$(document).scrollTop($('#top').offset().top);"><?php echo $ReportLanguage->Phrase("Top") ?></a>
<?php } ?>
