...
$Chart->ID = "GM58_Payments_Payments_28entered29_Pie_Graph"; // Chart ID
...
$Chart->SetChartParm("colorpalette", "#0000FF|#0080FF|#7AFFFF|#FF0000|#FF0080|#FF00FF|#8000FF|#FF8000|#FF3D3D|#FFFF00|#FF7A7A|#3DFFFF|#80FF00|#00FF00|#00FF80|#00FFFF", FALSE); // Chart color palette
?>
<?php
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_GM58_Payments_Payments_28entered29_Pie_Graph", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_GM58_Payments_Payments_28entered29_Pie_Graph_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
