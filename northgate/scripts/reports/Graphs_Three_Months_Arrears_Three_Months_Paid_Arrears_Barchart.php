...
$Chart->ID = "Graphs_Three_Months_Arrears_Three_Months_Paid_Arrears_Bar"; // Chart ID
...
$Chart->SetChartParm("colorpalette", "#0000FF|#0080FF|#3DFFFF|#FF0000|#FF0080|#FF00FF|#8000FF|#FF8000|#FF3D3D|#7AFFFF|#FFFF00|#FF7A7A|#80FF00|#00FF00|#00FF80|#00FFFF", FALSE); // Chart color palette
?>
<?php
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_Graphs_Three_Months_Arrears_Three_Months_Paid_Arrears_Bar", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_Graphs_Three_Months_Arrears_Three_Months_Paid_Arrears_Bar_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
