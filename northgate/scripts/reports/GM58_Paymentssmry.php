...
<?php } ?>
	<!-- Bottom slot -->
<a id="cht_GM58_Payments_Payments_28Entered29_Bar_Graph"></a>
<div class="">
<div id="div_ctl_GM58_Payments_Payments_28Entered29_Bar_Graph" class="ewChart">
<div id="div_GM58_Payments_Payments_28Entered29_Bar_Graph" class="ewChartDiv"></div>
<!-- grid component -->
<div id="div_GM58_Payments_Payments_28Entered29_Bar_Graph_grid" class="ewChartGrid"></div>
</div>
</div>
<?php

// Set up chart object
$Chart = &$Table->Payments_28Entered29_Bar_Graph;
...
?>
<?php include_once "GM58_Payments_Payments_28Entered29_Bar_Graphchart.php" ?>
...
<?php } ?>
<?php } ?>
<a id="cht_GM58_Payments_Payments_28entered29_Pie_Graph"></a>
<div class="">
<div id="div_ctl_GM58_Payments_Payments_28entered29_Pie_Graph" class="ewChart">
<div id="div_GM58_Payments_Payments_28entered29_Pie_Graph" class="ewChartDiv"></div>
<!-- grid component -->
<div id="div_GM58_Payments_Payments_28entered29_Pie_Graph_grid" class="ewChartGrid"></div>
</div>
</div>
<?php

// Set up chart object
$Chart = &$Table->Payments_28entered29_Pie_Graph;
...
$Chart->ShowTempImage = ($Page->Export == "pdf" || $Page->CustomExport <> "" || $Page->Export == "email" || $Page->Export == "excel" && defined("EWR_USE_PHPEXCEL") || $Page->Export == "word" && defined("EWR_USE_PHPWORD"));
?>
<?php include_once "GM58_Payments_Payments_28entered29_Pie_Graphchart.php" ?>
<?php if ($Page->Export <> "email" && !$Page->DrillDown) { ?>
<?php if ($Page->Export == "" && !$Page->DrillDown) { ?>
<a href="javascript:void(0);" class="ewTopLink" onclick="$(document).scrollTop($('#top').offset().top);"><?php echo $ReportLanguage->Phrase("Top") ?></a>
<?php } ?>
