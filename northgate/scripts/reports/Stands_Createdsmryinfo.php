...
class crStands_Created extends crTableBase {
	var $Stands_Created_Bar;
	var $Stands_Created_Pie;
	var $location;
	var $area;
	var $number;
	var $status;
	...
	function __construct() {
		...
		// Stands Created Bar
		$this->Stands_Created_Bar = new crChart($this->DBID, 'Stands_Created', 'Stands Created', 'Stands_Created_Bar', 'Stands Created Bar', 'status', 'number', '', 104, 'COUNT', 550, 440);
		$this->Stands_Created_Bar->SqlSelect = "SELECT `status`, '', COUNT(`number`) FROM ";
		$this->Stands_Created_Bar->SqlGroupBy = "`status`";
		$this->Stands_Created_Bar->SqlOrderBy = "";
		$this->Stands_Created_Bar->SeriesDateType = "";

		// Stands Created Pie
		$this->Stands_Created_Pie = new crChart($this->DBID, 'Stands_Created', 'Stands Created', 'Stands_Created_Pie', 'Stands Created Pie', 'status', 'number', '', 6, 'COUNT', 550, 440);
		$this->Stands_Created_Pie->SqlSelect = "SELECT `status`, '', COUNT(`number`) FROM ";
		$this->Stands_Created_Pie->SqlGroupBy = "`status`";
		$this->Stands_Created_Pie->SqlOrderBy = "";
		$this->Stands_Created_Pie->SeriesDateType = "";
	}
