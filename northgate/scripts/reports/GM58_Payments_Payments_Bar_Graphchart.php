...
// Set up chart
//$Chart = &$Table->Payments_Bar_Graph;
// Initialize chart data

$Chart->ID = "GM58_Payments_Payments_Bar_Graph"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_GM58_Payments_Payments_Bar_Graph", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_GM58_Payments_Payments_Bar_Graph_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
