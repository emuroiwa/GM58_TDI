...
$date1111 = date('Y-m-28');

 $interest=(($instalments*3)*0.1)/12;
...
$NumberOfMonths=GetMonthsPaid($debit,$instalments);
 $monthzDate=GetInstalmentMonthDate($purchasedate,GetMonthsPaid($debit,$instalments));
    mysql_query("INSERT INTO `payment` (`cash`, `stand`, `date`, `capturer`, `month`, `year`, `payment_type`, `d`, `payment_date`, `value_date`, `description`) VALUES ('$balance', '$stand', NOW(), '$_SESSION[name]', '$monthz', '$NumberOfMonths', 'Credit','Balance_After_VAT', now(), '$_POST[date1]','$_POST[txtDescription]')") or die (mysql_error());
	//Write to log file
