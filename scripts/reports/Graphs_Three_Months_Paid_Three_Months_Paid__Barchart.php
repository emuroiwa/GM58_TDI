...
// Set up chart
//$Chart = &$Table->Three_Months_Paid__Bar;
// Initialize chart data

$Chart->ID = "Graphs_Three_Months_Paid_Three_Months_Paid__Bar"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_Graphs_Three_Months_Paid_Three_Months_Paid__Bar", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_Graphs_Three_Months_Paid_Three_Months_Paid__Bar_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
