...
// Set up chart
//$Chart = &$Table->Three_Months_Paid_Pie;
// Initialize chart data

$Chart->ID = "Graphs_Three_Months_Paid_Three_Months_Paid_Pie"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_Graphs_Three_Months_Paid_Three_Months_Paid_Pie", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_Graphs_Three_Months_Paid_Three_Months_Paid_Pie_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
