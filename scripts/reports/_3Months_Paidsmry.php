...
<?php include_once "_3Months_Paidsmryinfo.php" ?>
<?php
...
$p_3Months_Paid_summary = NULL; // Initialize page object first

class crp_3Months_Paid_summary extends cr_3Months_Paid {
	...
	// Page object name
	var $PageObjName = 'p_3Months_Paid_summary';
	...
	function __construct() {
		...
		// Table object (_3Months_Paid)
		if (!isset($GLOBALS["_3Months_Paid"])) {
			$GLOBALS["_3Months_Paid"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["_3Months_Paid"];
		}
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", '3Months Paid', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption f_3Months_Paidsummary";
	}
...
//		$item->Visible = TRUE;
		...
		$item->Body = "<a title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf__3Months_Paid\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf__3Months_Paid',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"f_3Months_Paidsummary\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"f_3Months_Paidsummary\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"f_3Months_Paidsummary\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	//		$rs->MoveFirst(); // NOTE: no need to move position
				...
				$this->FirstRowData['stand'] = ewr_Conv($rs->fields('stand'),200);
				...
				$this->FirstRowData['YEAR'] = ewr_Conv($rs->fields('YEAR'),200);
		...
		if (!$rs->EOF) {
			...
			$this->stand->setDbValue($rs->fields('stand'));
			...
			$this->Val[1] = $this->cash->CurrentValue;
			$this->Val[2] = $this->capturer->CurrentValue;
			$this->Val[3] = $this->MONTH->CurrentValue;
			$this->Val[4] = $this->payment_type->CurrentValue;
			$this->Val[5] = $this->number->CurrentValue;
			$this->Val[6] = $this->instalments->CurrentValue;
			$this->Val[7] = $this->deposit->CurrentValue;
			$this->Val[8] = $this->months_paid->CurrentValue;
		} else {
			$this->cash->setDbValue("");
			$this->stand->setDbValue("");
...
// Create page object
if (!isset($p_3Months_Paid_summary)) $p_3Months_Paid_summary = new crp_3Months_Paid_summary();
if (isset($Page)) $OldPage = $Page;
$Page = &$p_3Months_Paid_summary;
...
// Create page object
var p_3Months_Paid_summary = new ewr_Page("p_3Months_Paid_summary");

// Page properties
p_3Months_Paid_summary.PageID = "summary"; // Page ID
var EWR_PAGE_ID = p_3Months_Paid_summary.PageID;

// Extend page with Chart_Rendering function
p_3Months_Paid_summary.Chart_Rendering = 
...
p_3Months_Paid_summary.Chart_Rendered = 
 function(chart, chartid) { // DO NOT CHANGE THIS LINE!
...
<?php include "_3Months_Paidsmrypager.php" ?>
<div class="clearfix"></div>
</div>
<?php } ?>
<!-- Report grid (begin) -->
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="cash"><div class="_3Months_Paid_cash"><span class="ewTableHeaderCaption"><?php echo $Page->cash->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="cash">
<?php if ($Page->SortUrl($Page->cash) == "") { ?>
		<div class="ewTableHeaderBtn _3Months_Paid_cash">
			<span class="ewTableHeaderCaption"><?php echo $Page->cash->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer _3Months_Paid_cash" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->cash) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->cash->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="capturer"><div class="_3Months_Paid_capturer"><span class="ewTableHeaderCaption"><?php echo $Page->capturer->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="capturer">
<?php if ($Page->SortUrl($Page->capturer) == "") { ?>
		<div class="ewTableHeaderBtn _3Months_Paid_capturer">
			<span class="ewTableHeaderCaption"><?php echo $Page->capturer->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer _3Months_Paid_capturer" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->capturer) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->capturer->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="MONTH"><div class="_3Months_Paid_MONTH"><span class="ewTableHeaderCaption"><?php echo $Page->MONTH->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="MONTH">
<?php if ($Page->SortUrl($Page->MONTH) == "") { ?>
		<div class="ewTableHeaderBtn _3Months_Paid_MONTH">
			<span class="ewTableHeaderCaption"><?php echo $Page->MONTH->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer _3Months_Paid_MONTH" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->MONTH) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->MONTH->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="payment_type"><div class="_3Months_Paid_payment_type"><span class="ewTableHeaderCaption"><?php echo $Page->payment_type->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="payment_type">
<?php if ($Page->SortUrl($Page->payment_type) == "") { ?>
		<div class="ewTableHeaderBtn _3Months_Paid_payment_type">
			<span class="ewTableHeaderCaption"><?php echo $Page->payment_type->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer _3Months_Paid_payment_type" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->payment_type) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->payment_type->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="number"><div class="_3Months_Paid_number"><span class="ewTableHeaderCaption"><?php echo $Page->number->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="number">
<?php if ($Page->SortUrl($Page->number) == "") { ?>
		<div class="ewTableHeaderBtn _3Months_Paid_number">
			<span class="ewTableHeaderCaption"><?php echo $Page->number->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer _3Months_Paid_number" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->number) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->number->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="instalments"><div class="_3Months_Paid_instalments"><span class="ewTableHeaderCaption"><?php echo $Page->instalments->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="instalments">
<?php if ($Page->SortUrl($Page->instalments) == "") { ?>
		<div class="ewTableHeaderBtn _3Months_Paid_instalments">
			<span class="ewTableHeaderCaption"><?php echo $Page->instalments->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer _3Months_Paid_instalments" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->instalments) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->instalments->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="deposit"><div class="_3Months_Paid_deposit"><span class="ewTableHeaderCaption"><?php echo $Page->deposit->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="deposit">
<?php if ($Page->SortUrl($Page->deposit) == "") { ?>
		<div class="ewTableHeaderBtn _3Months_Paid_deposit">
			<span class="ewTableHeaderCaption"><?php echo $Page->deposit->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer _3Months_Paid_deposit" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->deposit) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->deposit->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="months_paid"><div class="_3Months_Paid_months_paid"><span class="ewTableHeaderCaption"><?php echo $Page->months_paid->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="months_paid">
<?php if ($Page->SortUrl($Page->months_paid) == "") { ?>
		<div class="ewTableHeaderBtn _3Months_Paid_months_paid">
			<span class="ewTableHeaderCaption"><?php echo $Page->months_paid->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer _3Months_Paid_months_paid" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->months_paid) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->months_paid->FldCaption() ?></span>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>__3Months_Paid_cash"<?php echo $Page->cash->ViewAttributes() ?>><?php echo $Page->cash->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->capturer->Visible) { ?>
		<td data-field="capturer"<?php echo $Page->capturer->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>__3Months_Paid_capturer"<?php echo $Page->capturer->ViewAttributes() ?>><?php echo $Page->capturer->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->MONTH->Visible) { ?>
		<td data-field="MONTH"<?php echo $Page->MONTH->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>__3Months_Paid_MONTH"<?php echo $Page->MONTH->ViewAttributes() ?>><?php echo $Page->MONTH->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->payment_type->Visible) { ?>
		<td data-field="payment_type"<?php echo $Page->payment_type->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>__3Months_Paid_payment_type"<?php echo $Page->payment_type->ViewAttributes() ?>><?php echo $Page->payment_type->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->number->Visible) { ?>
		<td data-field="number"<?php echo $Page->number->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>__3Months_Paid_number"<?php echo $Page->number->ViewAttributes() ?>><?php echo $Page->number->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->instalments->Visible) { ?>
		<td data-field="instalments"<?php echo $Page->instalments->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>__3Months_Paid_instalments"<?php echo $Page->instalments->ViewAttributes() ?>><?php echo $Page->instalments->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->deposit->Visible) { ?>
		<td data-field="deposit"<?php echo $Page->deposit->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>__3Months_Paid_deposit"<?php echo $Page->deposit->ViewAttributes() ?>><?php echo $Page->deposit->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->months_paid->Visible) { ?>
		<td data-field="months_paid"<?php echo $Page->months_paid->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>__3Months_Paid_months_paid"<?php echo $Page->months_paid->ViewAttributes() ?>><?php echo $Page->months_paid->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
