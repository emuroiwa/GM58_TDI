...
$Chart->ID = "Graphs_Three_Months_Paid_Three_Months_Paid_Arrears_Bar"; // Chart ID
...
$Chart->SetChartParm("alpha", "70", FALSE); // Chart alpha
$Chart->SetChartParm("colorpalette", "#1E90FF|#0000CD|#99FFFF|#8000FF|#FF8000|#FF3D3D|#7AFFFF|#0000FF|#FFFF00|#FF7A7A|#3DFFFF|#0080FF|#80FF00|#00FF00|#00FF80|#00FFFF", FALSE); // Chart color palette
?>
<?php
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_Graphs_Three_Months_Paid_Three_Months_Paid_Arrears_Bar", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_Graphs_Three_Months_Paid_Three_Months_Paid_Arrears_Bar_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
