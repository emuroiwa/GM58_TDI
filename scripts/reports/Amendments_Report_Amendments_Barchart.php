...
$Chart->ID = "Amendments_Report_Amendments_Bar"; // Chart ID
...
$Chart->SetChartParm("colorpalette", "#0066FF|#0000FF|#FF00FF|#8000FF|#FF8000|#FF3D3D|#7AFFFF|#0000FF|#FFFF00|#FF7A7A|#3DFFFF|#0080FF|#80FF00|#00FF00|#00FF80|#00FFFF", FALSE); // Chart color palette
?>
<?php
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_Amendments_Report_Amendments_Bar", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_Amendments_Report_Amendments_Bar_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
