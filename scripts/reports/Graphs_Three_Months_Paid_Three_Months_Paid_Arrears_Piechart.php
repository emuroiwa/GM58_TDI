...
$Chart->ID = "Graphs_Three_Months_Paid_Three_Months_Paid_Arrears_Pie"; // Chart ID
...
$Chart->SetChartParm("colorpalette", "#0000FF|#9900FF|#00FFFF|#8000FF|#FF8000|#FF3D3D|#7AFFFF|#0000FF|#FFFF00|#FF7A7A|#3DFFFF|#0080FF|#80FF00|#00FF00|#00FF80|#00FFFF", FALSE); // Chart color palette
?>
<?php
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_Graphs_Three_Months_Paid_Three_Months_Paid_Arrears_Pie", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_Graphs_Three_Months_Paid_Three_Months_Paid_Arrears_Pie_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
