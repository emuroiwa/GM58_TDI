...
// Set up chart
//$Chart = &$Table->Three_Months_Paid_Doughnut_3D_Chart;
// Initialize chart data

$Chart->ID = "Graphs_Three_Months_Paid_Three_Months_Paid_Doughnut_3D_Chart"; // Chart ID
$Chart->SetChartParms(array(array("type", "101", FALSE),
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_Graphs_Three_Months_Paid_Three_Months_Paid_Doughnut_3D_Chart", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_Graphs_Three_Months_Paid_Three_Months_Paid_Doughnut_3D_Chart_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
