...
$Chart->ID = "Amendments_Report_Amendments_Pie"; // Chart ID
...
$Chart->SetChartParm("colorpalette", "#0000FF|#0080FF|#3DFFFF|#FF0080|#FF0000|#FF00FF|#8000FF|#FF8000|#FF3D3D|#7AFFFF|#FFFF00|#FF7A7A|#80FF00|#00FF00|#00FF80|#00FFFF", FALSE); // Chart color palette
?>
<?php
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_Amendments_Report_Amendments_Pie", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_Amendments_Report_Amendments_Pie_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
