...
<?php
 ...
 $rs = mysql_query("insert into stand(location,number,area,date,price,status,datestatus) values ('$_POST[location]','$_POST[number]','$_POST[area]','$date','$_POST[price]','RESERVED','$date')") or die(mysql_error());
