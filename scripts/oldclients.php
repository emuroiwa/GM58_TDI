...
<table width="100%" bgcolor="#A7A7A7" border="1">
  ...
  <?php if($_GET['type']=="R") {
    ?>
     <div align="center"><font color="red"> <a href="index.php?page=ReserveClient.php&id=<?php echo $_REQUEST['id']; ?>&client=<?php echo $info['id']; ?>"><strong>CLICK TO ADD CLIENT TO RESERVED STAND</strong></a></font>
  </div><?php
    }else
    {?>

 <div align="center"><font color="red"> <a href="index.php?page=oldclient_transition.php&id=<?php echo $_REQUEST['id']; ?>&client=<?php echo $info['id']; ?>"><strong>CLICK TO MAKE DEPOSIT</strong></a></font>
  </div>
    <?php
