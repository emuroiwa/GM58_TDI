...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "gm58", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'rtuh1tkOrj0a8mdu', TRUE); // Random key for encryption
