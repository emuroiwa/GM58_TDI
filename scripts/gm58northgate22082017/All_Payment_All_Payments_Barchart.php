...
$Chart->ID = "All_Payment_All_Payments_Bar"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_All_Payment_All_Payments_Bar", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_All_Payment_All_Payments_Bar_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
