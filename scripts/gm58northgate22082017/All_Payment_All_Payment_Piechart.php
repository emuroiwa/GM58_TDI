...
$Chart->ID = "All_Payment_All_Payment_Pie"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_All_Payment_All_Payment_Pie", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_All_Payment_All_Payment_Pie_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
