...
FROM `cashoutpayment`
WHERE
cashoutpayment.stand='$_GET[id]' and d='Stand Deposit' order by id ASC  ")or die(mysql_query());
...
FROM `cashoutpayment`
WHERE
cashoutpayment.stand='$_GET[id]' and payment_type='credit' and d<>'Stand Deposit' order by id ASC  ")or die(mysql_query());
...
<a href="cashoutstatement_print.php?id=<?php echo $stand;?>" target="_blank" class='btn btn-success'>&nbsp;<i class='icon-file-alt icon-large'></i>&nbsp; <strong>CLICK TO PRINT</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php?page=NewPayment.php&id=<?php echo $stand;?>"  class='btn btn-success'>&nbsp;<i class='icon-file-alt icon-large'></i>&nbsp; <strong>CLICK TO PROCESS PAYMENT</a></strong>
</td>
  </tr>
</table>
