...
$Chart->ID = "Last_Payment_Made_Bar_Graph"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_Last_Payment_Made_Bar_Graph", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_Last_Payment_Made_Bar_Graph_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
