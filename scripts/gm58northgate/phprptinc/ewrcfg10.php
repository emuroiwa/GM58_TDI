...
define("EWR_PROJECT_ID", "{8971DFF8-CD58-406F-905F-ABF6EB424D34}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "gm58northgate", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "northgate2014", "db" => "gm58", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'V9aMACHNHeSYUo36', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/gm58northgate.css", TRUE); // Project stylesheet file name
