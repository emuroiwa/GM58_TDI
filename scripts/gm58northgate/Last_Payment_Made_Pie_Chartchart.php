...
$Chart->ID = "Last_Payment_Made_Pie_Chart"; // Chart ID
...
$Chart->Trends[] = array(0, 0, "0033FF", "", 1, "0", "1", 100, "", "0", "0", 0, 0, "");
$Chart->Trends[] = array(0, 0, "CC99FF", "", 1, "0", "1", 100, "", "0", "0", 0, 0, "");
$Chart->Trends[] = array(0, 0, "FF0000", "", 1, "0", "1", 100, "", "0", "0", 0, 0, "");
$Chart->Trends[] = array(0, 0, "3333CC", "", 1, "0", "1", 100, "", "0", "0", 0, 0, "");
?>
<?php
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_Last_Payment_Made_Pie_Chart", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_Last_Payment_Made_Pie_Chart_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
